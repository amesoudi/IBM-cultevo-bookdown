...
First we'll specify our parameters, $N$ and $p_0$ as before, plus the new conformity parameter $D$. We can also create a **population** tibble and fill it with $A$s and $B$s in the proportion specified by $p_0$, again exactly as before. 

TO DO

To remind ourselves what *agent* looks like, we use the **head** command.
