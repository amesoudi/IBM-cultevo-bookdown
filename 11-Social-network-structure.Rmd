...
First, let us write down a function to generate networks as we have done above:
```{r}
...
ggplot(data, aes(x=connectivity, y=meanTime, col=factor(groupSize))) + geom_line() + geom_point() + theme_bw()
```
