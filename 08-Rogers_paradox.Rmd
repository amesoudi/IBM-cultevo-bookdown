...
output <- tibble(generation = rep(1:t_max, r_max), run = as.factor(rep(1:r_max, each = t_max)), p.SL = rep(NA, t_max * r_max), W = rep(NA, t_max * r_max))
