...
If you rund this code repeatedly, you will see that on average the frequency of the behaviour will still be around 0.5. This is what we expect because individuals do not choose one over the other cluster to learn from. 
...
So far, an individual is equally likely to learn from any other individual in the entire population. However, let us assume that the clusters are completely isolated from each other. Thus, an individaul is only looking for a model within its own cluster:
